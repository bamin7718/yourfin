...
│   ├── chart-test.js           canvas giả để chạy thật hit-test biểu đồ (39 assertion)
...
npm install jsdom --no-save && npm test   # smoke 303 + sync 20 + transfer 23 + chart 39 + header 22
```
